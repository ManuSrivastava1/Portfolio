...
function fetchData (name){
    ...
    if (name === 'Predicting pollution level with an LSTM model') {
        abstract = 'This project was done as as an end-of-course project for the "Machine Learning systems for Data Science" course of the Master Degree in Digital Humanities and Digital Knowledge of the University of Bologna, held by professors Stefano Lodi and Elisabetta Ronchieri.The purpose of the project is to replicate the work process used for the case study in the research paper "Prediction of air quality in Jakarta during the COVID-19 outbreak using long short-term memory machine learning" by Wihayati and F W Wibowo 2021 IOP Conf. Ser.: Earth Environ. Sci. 704 012046.The data used in the project was provided by the prfessor and the links to the data source and other information about the project can be found on the project repository.' ;
       ...
       abstract = "Bars Behind Bars is a project developed for final exam of the Open Access and Digital Ethics course of the Master’s degree in Digital Humanities and Digital Knowledge of the University of Bologna. The project aims at analysing the impact of different factors in the context of suicide in prisons across Europe.This website works as a documentation of the process leading from the choice of the datasets along with their ethical, technological, legal, and qualitative analyses, to the visualisation of the results. The documentation as Jupyter Notebook can be downloaded from the button below. Further information can be found on GitHub."; 
       ...
       abstract = 'This was the final Project delivered for the "Data Science" course ("Computational Management of Data") taught by Silvio Peroni @ University of Bologna, MA "DHDK". The goal of the project is to develop a software that enables one to process data stored in different formats and to upload them into two distinct databases to query these databases simultaneously according to predefined operations. The software must be accompanied by a document (i.e., a Jupyter notebook) describing the data to process (their main characteristics and possible issues) and how the software has been organised (name of the files, where have been defined the various Python classes, etc.). The required structure of the database as well as its required functioning queries were provided by the professor as a UML model and we had to construct it in python. The documentation and our final code can be found in the project repository. '; 
       ...
       abstract = 'NFT-iness project is an attempt at exploration of the activity on the Ethereum non-fungible token (NFT) market from 2017 and early 2023 constructed from the API of Etherscan. We have consider the following questions:Who owns NFTs on the Ethereum blockchain? Are NFTs being traded in a bubble? We explore this idea in the "commerce of NFT" section of the website. What are the trends in NFT market? What is the growth pattern of this market? We explore this idea in the "trends in NFT" section of the website. The aim was to scrape data of NFT transactions and visualise them in suitable manner to see under-lying patterns which could help provide answers to the above listed questions.'; 
       ...
       abstract = 'This thesis delves into the realm of computational semantics and explores the optimization of semantic parsing systems,driven by the increasing demand for sophisticated natural language processing(NLP)technologies in applications like question-answer systems and dialogue systems, including platforms such as ChatGPT.Motivated by the need to enhance the performance of AI systems and mitigate biases and miscommunications the study focuses on deep-learning-based semantic parsing, aiming to optimize it’s expressivity and performance through hyper-parameter tuning and experimentation with components such as language models. The research investigates the potential benefits of using larger architecture language models and fine-tuned graph embedding generators Leveraging a frame identification system combining the prowess of modern language model and AdaptiveGraphEncoder,the study systematically explores the impact of hyper-parameter tuning and component replacements on system performance.Through meticulous experimentation and performance evaluation, insights into the system’s robustness, efficiency, and adaptability are gained, informing future optimizations in frame identification using deeplearning methods.'; 
       tags = 'Computationalsemantics, Semanticparsing, Naturallanguageprocessing, Deeplearning, Hyper-parametertuning,Languagemodels, Frameidentification, Graphembeddings, Performanceevaluation';
       buttons = []}
